...
try:
    ...
    print(pod_subscription.consume_subscription(subscription_id=2543))
    ...
    print(pod_subscription.consume_subscription(subscription_id=2543, used_amount=100.5))
